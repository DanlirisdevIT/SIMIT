...
class CreateAgPengeluaransTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('ag_pengeluarans', function (Blueprint $table) {
            $table->id();
            $table->date('date');
            ...
            $table->unsignedBigInteger('ag_pemasukan_id')->nullable();
            $table->foreign('ag_pemasukan_id')->references('id')->on('ag_pemasukans')->onDelete('cascade')->onUpdate('cascade');
    ...
    {
        Schema::dropIfExists('ag_pengeluarans');
    }
}
