...
class CreateDanlirisPemasukansTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('danliris_pemasukans', function (Blueprint $table) {
            $table->id();
            // $table->string('dl_uid');
            $table->date('date');
            ...
            $table->unsignedBigInteger('danliris_budget_id')->nullable();
            $table->foreign('danliris_budget_id')->references('id')->on('danliris_budgets')->onDelete('cascade')->onUpdate('cascade');
    ...
    {
        Schema::dropIfExists('danliris_pemasukans');
    }
}
