...
class CreateDanlirisPengeluaransTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('danliris_pengeluarans', function (Blueprint $table) {
            $table->id();
            $table->date('date');
            ...
            $table->unsignedBigInteger('danliris_pemasukan_id')->nullable();
            $table->foreign('danliris_pemasukan_id')->references('id')->on('danliris_pemasukans')->onDelete('cascade')->onUpdate('cascade');
    ...
    {
        Schema::dropIfExists('danliris_pengeluarans');
    }
}
