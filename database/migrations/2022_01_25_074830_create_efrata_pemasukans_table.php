...
class CreateEfrataPemasukansTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('efrata_pemasukans', function (Blueprint $table) {
            $table->id();
            // $table->string('ef_uid');
            $table->date('date');
            ...
            // $table->unsignedBigInteger('efrata_permintaan_id')->nullable();
            // $table->foreign('efrata_permintaan_id')->references('id')->on('efrata_permintaans')->onDelete('cascade')->onUpdate('cascade');
            $table->unsignedBigInteger('efrata_budget_id')->nullable();
            $table->foreign('efrata_budget_id')->references('id')->on('efrata_budgets')->onDelete('cascade')->onUpdate('cascade');
    ...
    {
        Schema::dropIfExists('efrata_pemasukans');
    }
}
