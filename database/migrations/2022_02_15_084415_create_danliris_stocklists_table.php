...
class CreateDanlirisStocklistsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('danliris_stocklists', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::dropIfExists('danliris_stocklists');
    }
}
