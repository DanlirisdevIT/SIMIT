    ...
    <script type="text/javascript">
        ...
        $(document).ready(function () {
            ...
            $("#danliris_permintaan_id").on('change', function() {
                    var danliris_permintaan_id = $("#danliris_permintaan_id").val();
                    ...
                    $.ajax({
                        ...
                        success: function(response){
                            ...
                            $('#quantity').val(response.danliris_permintaans.quantity);
                            }
                        }
                    })
            })
            ...
            $.ajax({
                ...
                success: function(response){
                    ...
                    else
                    {
                        ...
                        var option_permintaan = '<option value = "'+response.danliris_permintaans.id+'" selected> --- '+response.danliris_permintaans.username+' --- </option>'
