    ...
    <script type="text/javascript">
        $(function() {
            ...
            var table = $('.datatables').DataTable({
                ...
                processing: true,
                serverSide: true,
                ajax: "{{ route('ag_pengeluaran.index') }}",
                method: 'GET',
                columns: [
        ...
        $(document).ready(function () {
            ...
            $('#pengeluaran_type').on('change', function() {
                ...
                if(pengeluaran_type == 'from permintaan')
                {
                    function fetchPemasukan(){
                       $.ajax({
                            type: "GET",
                            url: "{{ route('getPemasukan_ag') }}",
                            dataType: "json",
                            success: function(response)
                            {
                                if(response.status == 200)
                                {
                                    dropdown = '<label name="ag_pemasukan_id" class="col-sm-4 control-label"> Pemasukan UID </label>';
                                    dropdown = dropdown + '<select class="form-control" id="ag_pemasukan_id" name="ag_pemasukan_id">';
                                    ...
                                    $.each(response.ag_pemasukans_1, function(index, pemasukan) {
                                        $('select[name="ag_pemasukan_id"]').append('<option value="'+pemasukan.id+'">'+pemasukan.ag_uid+'</option>')
                                    })

                                    //do 'input' js event
                                    $('#ag_pemasukan_id').on('input', function() {
                                        var ag_pemasukan_id = $('#ag_pemasukan_id').val()

                                        usePemasukan(ag_pemasukan_id)
                                    })
                                }
                            }
                        });
                    ...
                    function usePemasukan(ag_pemasukan_id){
                        $('#ag_pemasukan_id').on('change', function() {
                                $.ajax({
                                type: "GET",
                                url: "{{ route('ag_pengeluaran.create') }}",
                                data:  {'ag_pemasukan_id' : ag_pemasukan_id},
                                dataType: "json",
                                beforeSend : function()
                                {
                                    console.log(ag_pemasukan_id);
                                },
                                success: function(response)
                                {
                                    if(response.status == 200)
                                    {
                                        ...
                                        category_type = category_type + '<input type="text" class="form-control" id="category_type" name="category_type" value="'+response.ag_pemasukan.category_type+'" maxlength="50" readonly>';
                                        ...
                                        category_name = category_name + '<input type="text" class="form-control" id="category_name" name="category_name" value="'+response.ag_pemasukan.category_name+'" maxlength="50" readonly>';
                                        ...
                                        barcode = barcode + '<input type="text" class="form-control" id="barcode" name="barcode" value="'+response.ag_pemasukan.barcode+'" maxlength="50" readonly>';
                                        barcode = barcode + '</div>';
                ...
                else if(pengeluaran_type == "from it stock")
                {
                        ...
                        $.ajax({
                            ...
                            success: function(response)
                            {
                                if(response.status == 200)
                                {
                                    ...
                                    $.each(response.ag_pemasukans_2, function(index, pemasukan) {
                                        $('select[name="ag_pemasukan_id"]').append('<option value="'+pemasukan.id+'">'+pemasukan.ag_uid+'</option>')
                                    })
                                    ...
                                    $('#ag_pemasukan_id').on('input', function() {
                                        ...
                                        usePemasukan_2(ag_pemasukan_id)
                                    })
                                }
                            }
                        })
                    ...
                    function usePemasukan_2(ag_pemasukan_id){
                        $('#ag_pemasukan_id').on('change', function() {
                                $.ajax({
                                type: "GET",
                                url: "{{ route('ag_pengeluaran.create') }}",
                                ...
                                success: function(response)
                                {
                                    if(response.status == 200)
                                    {
                                        ...
                                        permintaan_user = '<label name="username" class="col-sm-4 control-label"> User Penerimaan </label>';
                                        permintaan_user = permintaan_user + '<div class="col-sm-12">';
                                        permintaan_user = permintaan_user + '<input type="text" class="form-control" id="username" name="username" value="" placeholder="Masukkan nama user penerima..." maxlength="50">';
                                        permintaan_user = permintaan_user + '</div>';
            ...
            $(document).on('click', '.create', function (e) {
                ...
                var data = {
                    ...
                    'ag_pemasukan_id': $('#ag_pemasukan_id').val(),
                ...
                $.ajax({
                    method: "POST",
                    data: data,
                    url: "{{ route('ag_pengeluaran.store') }}",
                    dataType: "json",
                    success: function(response)
                    {
        ...
        $(document).on('click', '.editPengeluaran', function(e) {
            ...
            $.ajax({
                type: "GET",
                url: "{{ route('ag_pengeluaran.index') }}" + '/' + id + '/edit',
                dataType: "json",
                success: function (response) {
                    ...
                    {
                        $('#id').val(id)
                        $('#updatePengeluaran').find('#date').val(response.ag_pengeluarans.date);
                        $('#updatePengeluaran').find('#pengeluaran_type').val(response.ag_pengeluarans.pengeluaran_type);
                        // $('#updatePengeluaran').find('#ag_pemasukan_id').val(response.ag_pemasukans.id);
                        // $('#updatePengeluaran').find('#namaBarangForm').val(response.ag_pengeluarans.category_name);
                        // $('#updatePengeluaran').find('#kategoriBarangForm').val(response.ag_pengeluarans.category_type);
                        // $('#updatePengeluaran').find('#barcodeForm').val(response.ag_pengeluarans.barcode);
                        // $('#updatePengeluaran').find('#assetipForm').val(response.ag_pengeluarans.asset_ip);
                        // $('#updatePengeluaran').find('#quantityForm').val(response.ag_pengeluarans.quantity);
                        // $('#updatePengeluaran').find('#deskripsiForm').val(response.ag_pengeluarans.description);
                        // $('#updatePengeluaran').find('#unitForm').val(response.ag_pengeluarans.unit_name);
                        // $('#updatePengeluaran').find('#divisiForm').val(response.ag_pengeluarans.division_name);

                        console.log(response.ag_pemasukans.dl_uid)
                        ...
                        pengeluaran_type = pengeluaran_type + '<input type="text" class="form-control" id="pengeluaran_type" name="pengeluaran_type" value="'+response.ag_pengeluarans.pengeluaran_type+'" maxlength="50" readonly>';
                        pengeluaran_type = pengeluaran_type + '</div>';

                        dropdown = '<label name="ag_pemasukan_id" class="col-sm-4 control-label"> Pemasukan UID </label>';
                        dropdown = dropdown + '<select class="form-control" id="ag_pemasukan_id" name="ag_pemasukan_id">';
                        dropdown = dropdown + '<option value = "'+response.ag_pemasukans.id+'" selected> --- '+response.ag_pemasukans.ag_uid+' --- </option>';
                        dropdown = dropdown + '</select>';

                        category_type = '<label name="category_type" class="col-sm-4 control-label"> Tipe Kategori </label>';
                        category_type = category_type + '<div class="col-sm-12">';
                        category_type = category_type + '<input type="text" class="form-control" id="category_type" name="category_type" value="'+response.ag_pengeluarans.category_type+'" maxlength="50" readonly>';
                        category_type = category_type + '</div>';

                        category_name = '<label name="category_name" class="col-sm-4 control-label"> Nama Barang </label>';
                        category_name = category_name + '<div class="col-sm-12">';
                        category_name = category_name + '<input type="text" class="form-control" id="category_name" name="category_name" value="'+response.ag_pengeluarans.category_name+'" maxlength="50" readonly>';
                        category_name = category_name + '</div>';

                        barcode = '<label name="barcode" class="col-sm-4 control-label"> Barcode </label>';
                        barcode = barcode + '<div class="col-sm-12">';
                        barcode = barcode + '<input type="text" class="form-control" id="barcode" name="barcode" value="'+response.ag_pengeluarans.barcode+'" maxlength="50" readonly>';
                        barcode = barcode + '</div>';

                        permintaan_user = '<label name="username" class="col-sm-4 control-label"> User Penerima </label>';
                        permintaan_user = permintaan_user + '<div class="col-sm-12">';
                        permintaan_user = permintaan_user + '<input type="text" class="form-control" id="username" name="username" value="'+response.ag_pengeluarans.username+'" maxlength="50">';
                        permintaan_user = permintaan_user + '</div>';

                        asset_ip = '<label name="asset_ip" class="col-sm-4 control-label"> IP Address </label>';
                        asset_ip = asset_ip + '<div class="col-sm-12">';
                        asset_ip = asset_ip + '<input type="" class="form-control" id="asset_ip" name="asset_ip" value='+response.ag_pengeluarans.asset_ip+' maxlength="50" required>';
                        asset_ip = asset_ip + '</div>';

                        if(!response.ag_pengeluarans.quantity)
                        {
                            quantity = '<label name="quantity" class="col-sm-4 control-label"> Jumlah </label>';
                            quantity = quantity + '<div class="col-sm-12">';
                        ...
                        else
                        {
                            quantity = '<label name="quantity" class="col-sm-4 control-label"> Jumlah </label>';
                            quantity = quantity + '<div class="col-sm-12">';
                            quantity = quantity + '<input type="number" class="form-control" id="quantity" name="quantity" value='+response.ag_pengeluarans.quantity+' maxlength="50" required>';
                            quantity = quantity + '</div>';
                        }


                        if(!response.ag_pengeluarans.description)
                        {
                            description = '<label name="description" class="col-sm-4 control-label"> Deskripsi </label>';
                            description = description + '<div class="col-sm-12">';
                            description = description + '<textarea type="text" class="form-control" id="description" name="description" value='+response.ag_pengeluarans.description+' maxlength="50"></textarea>';
                            description = description + '</div>';
                        }
                        else
                        {
                            description = '<label name="description" class="col-sm-4 control-label"> Deskripsi </label>';
                            description = description + '<div class="col-sm-12">';
                            description = description + '<textarea type="text" class="form-control" id="description" name="description" value='+response.ag_pengeluarans.description+' maxlength="50">'+response.ag_pengeluarans.description+'</textarea>';
                            description = description + '</div>';
                        }

                        unit = '<label name="unit_name" class="col-sm-4 control-label"> Unit </label>';
                        unit = unit + '<div class="col-sm-12">';
                        unit = unit + '<input type="text" class="form-control" id="unit_name" name="unit_name" value="'+response.ag_pengeluarans.unit_name+'" maxlength="50" readonly>';
                        unit = unit + '</div>';

                        divisi = '<label name="division_name" class="col-sm-4 control-label"> Divisi </label>';
                        divisi = divisi + '<div class="col-sm-12">';
                        divisi = divisi + '<input type="text" class="form-control" id="division_name" name="division_name" value="'+response.ag_pengeluarans.division_name+'" maxlength="50" readonly>';
                        divisi = divisi + '</div>';
                        ...
                        if(response.ag_pengeluarans.pengeluaran_type == "from permintaan")
                        {
                            showForm.show()
                        ...
                        else if(response.ag_pengeluarans.pengeluaran_type == "to aval")
                        {
                            showForm_cat_type.show();
                            showForm_cat_name.show();
                            showForm_barcode.show();
        ...
        $(document).on('click', '.update', function(e) {
            ...
            var formData = {
                ...
                ag_pemasukan_id: $('#updatePengeluaranForm').find('#ag_pemasukan_id').val(),
