...
@section('content')
                        ...
                        <div class="card-body">
                            ...
                            <div class="modal fade" id="importPdf" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                <div class="modal-dialog" role="document">
                                    <form method="POST" action="{{ route('ag_serah_terima.index') }}" enctype="multipart/form-data">
                                        <div class="modal-content">
                                            <div class="modal-header">
                                                <h5 class="modal-title" id="exampleModalLabel">Upload Serah terima</h5>
                                            </div>
                                            ...
                                            @endif
                                                ...
                                                <form method="POST" action="{{ route('ag_serah_terima.index') }}" enctype="multipart/form-data">
                                                    ...
                                                    <div class="form-group row">
                                                        <div class="col-md-4">
                                                            <input type="file" name="datefile" required>
                                                        </div>
                                                    </div>
    ...
    <script type="text/javascript">
        ...
        var table = $('.datatables').DataTable({
                ...
                processing: true,
                serverSide: true,
                ajax: "{{ route('ag_serah_terima.index') }}",
                method: 'GET',
                columns: [
