            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="card card-primary card-outline">
                        <div class="card-body">
                            <h2 class="mb-4">Pergantian Wifi</h2>
                            ...
                            <div class="modal fade" id="importPdf" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                <div class="modal-dialog" role="document">
                                    <form method="POST" action="{{ route('danliris_change_wifi.index') }}" enctype="multipart/form-data">
                                        <div class="modal-content">
                                            <div class="modal-header">
                                                <h5 class="modal-title" id="exampleModalLabel">Upload Pergantian Wifi</h5>
                                            </div>
                            ...
                            @csrf
                                <table class="table table-bordered">
                                    ...
                                    <tbody>
                                        @php $i=1 @endphp
                                        @foreach($danliris_change_wifi as $change_wifi)
                                        <tr>
                                            <td>{{ $i++ }}</td>
                                            <td>{{ $change_wifi->datafile }}</td>
                                            <td>{{ $change_wifi->created_at }}</td>
                                        </tr>
                                        @endforeach
                                    </tbody>
                                </table>
