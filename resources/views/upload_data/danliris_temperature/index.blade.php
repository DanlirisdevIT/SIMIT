...
@section('content')
                        ...
                        <div class="card-body">
                            ...
                            <div class="modal fade" id="importPdf" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                <div class="modal-dialog" role="document">
                                    <form method="POST" action="{{ route('danliris_temperature.index') }}" enctype="multipart/form-data">
                                        <div class="modal-content">
                                            ...
                                            <p class="fw-normal fs-6">Acceptable file types are PDF, XLSX, XLS.
                                            </p>
    ...
    <script type="text/javascript">
        ...
        var table = $('.datatables').DataTable({
                ...
                processing: true,
                serverSide: true,
                ajax: "{{ route('danliris_temperature.index') }}",
                method: 'GET',
                columns: [
