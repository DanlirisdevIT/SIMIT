            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="card card-primary card-outline">
                        <div class="card-body">
                            <h2 class="mb-4">Kalibrasi Alat</h2>
                            ...
                            <div class="modal fade" id="importPdf" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                <div class="modal-dialog" role="document">
                                    <form method="POST" action="{{ route('danliris_kalibrasi_alat.index') }}" enctype="multipart/form-data">
                                        <div class="modal-content">
                                            <div class="modal-header">
                                                <h5 class="modal-title" id="exampleModalLabel">Upload Kalibrasi Alat</h5>
                                            </div>
                            ...
                            @csrf
                                <table class="table table-bordered">
                                    ...
                                    <tbody>
                                        @php $i=1 @endphp
                                        @foreach($danliris_kalibrasi_alat as $kalibrasi_alat)
                                        <tr>
                                            <td>{{ $i++ }}</td>
                                            <td>{{ $kalibrasi_alat->datafile }}</td>
                                            <td>{{ $kalibrasi_alat->created_at }}</td>
                                        </tr>
                                        @endforeach
                                    </tbody>
                                </table>
