            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="card card-primary card-outline">
                        <div class="card-body">
                            <h2 class="mb-4">Pergantian User Email</h2>
                            ...
                            <div class="modal fade" id="importPdf" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                <div class="modal-dialog" role="document">
                                    <form method="POST" action="{{ route('efrata_change_email_user.index') }}" enctype="multipart/form-data">
                                        <div class="modal-content">
                                            <div class="modal-header">
                                                <h5 class="modal-title" id="exampleModalLabel">Upload Pergantian User Email</h5>
                                            </div>
                            ...
                            @csrf
                                <table class="table table-bordered">
                                    ...
                                    <tbody>
                                        @php $i=1 @endphp
                                        @foreach($efrata_change_email_users as $change_user)
                                        <tr>
                                            <td>{{ $i++ }}</td>
