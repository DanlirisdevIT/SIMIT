    ...
    <script type="text/javascript">
        $(function() {
            ...
            var table = $('.datatables').DataTable({
                ...
                processing: true,
                serverSide: true,
                ajax: "{{ route('efrata_permintaan.index') }}",
                method: 'GET',
                // type: "GET",
        ...
        $(document).ready(function () {
            ...
            $(document).on('click', '.create', function (e) {
                ...
                $.ajax({
                    method: "POST",
                    data: data,
                    url: "{{ route('efrata_permintaan.store') }}",
                    dataType: "json",
        ...
        $(document).on('click', '.editPermintaan', function(e) {
            ...
            $.ajax({
                type: "GET",
                url: "{{ route('efrata_permintaan.index') }}" + '/' + id + '/edit',
                success: function (response) {
                    ...
                    else
                    {
                        ...
                        $('#updatePermintaan').find('#date').val(response.efrata_permintaans.date);
                        $('#updatePermintaan').find('#username').val(response.efrata_permintaans.username);
                        ...
                        $('#updatePermintaan').find('#quantity').val(response.efrata_permintaans.quantity);
                        $('#updatePermintaan').find('#description').val(response.efrata_permintaans.description);
                    }
                }
            })
        })
