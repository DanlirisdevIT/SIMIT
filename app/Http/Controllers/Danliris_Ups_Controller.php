...
use App\Models\Danliris_Ups;
use Illuminate\Support\Facades\Validator;
use Yajra\DataTables\Facades\DataTables;
use Illuminate\Support\Facades\Auth;

class Danliris_Ups_Controller extends Controller
{
    /**
    ...
    {
        $danliris_ups = Danliris_Ups::get();
        if($request->ajax()){
            return DataTables::of($danliris_ups)
            ->addIndexColumn()
            ->make(true);
        }
        return view('upload_data.danliris_ups.index')->with('danliris_ups', $danliris_ups);
    }
